...
import { validateProfileUpdate, validateChangePassword } from '../../middleware/validation/validation.js';
const router = Router();
 ...
 *     description: Upload failed
 */
router.post('/avatar-optimized', (req, res, next) => {
 ...
 * @access Private
 */
router.delete('/file/:fileType/:fileKey', async (req, res) => {
