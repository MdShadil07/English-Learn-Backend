...
class GoogleOAuthService {
    ...
    constructor() {
        ...
        this.oauth2Client = new google.auth.OAuth2(googleOAuthConfig.clientId, googleOAuthConfig.clientSecret, googleOAuthConfig.redirectUri);
    }
    /**
    ...
    async exchangeCodeForTokens(code) {
        try {
            ...
            return await this.handleGoogleAuth(userInfo.data);
        }
        catch (error) {
     ...
     */
    async linkGoogleAccount(userId, googleToken) {
        try {
     ...
     */
    async handleGoogleAuth(userInfo) {
        try {
