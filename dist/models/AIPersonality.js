...
const aiPersonalitySchema = new Schema({
    name: {
        type: String,
...
aiPersonalitySchema.statics.findByPersonalityType = function (personalityType) {
...
const AIPersonality = mongoose.model('AIPersonality', aiPersonalitySchema);
export default AIPersonality;
//# sourceMappingURL=AIPersonality.js.map