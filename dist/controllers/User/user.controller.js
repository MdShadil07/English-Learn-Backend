...
export class UserController {
    ...
    async updateProfile(req, res) {
        try {
            ...
            // Update user
            const updatedUser = await User.findByIdAndUpdate(userId, updateFields, { new: true, runValidators: true }).select('firstName lastName username email role createdAt updatedAt');
            if (!updatedUser) {
