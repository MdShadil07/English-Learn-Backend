...
Respond in JSON format:
{
  ...
  "strengths": ["<strength 1>", "<strength 2>"]
            ...
            nlpLogger.info({ score: result.score, duration, model: this.model }, 'OpenRouter fluency analysis complete');
            return result;
        }
        catch (error) {
            nlpLogger.error({
...
//# sourceMappingURL=OpenRouterDetector.js.map