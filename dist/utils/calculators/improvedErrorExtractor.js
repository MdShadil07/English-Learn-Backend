 ...
 */
function semanticDifference(a, b) {
 ...
 * MAIN MODULE
 */
export function extractErrorsFromAIResponseImproved(userMessage, aiResponse, result, features) {
    ...
    // ---------------------------
    if (detected > 0) {
        const cap = (x) => Math.min(5, Math.max(0, x));
        ...
        result.aiResponseAnalysis = result.aiResponseAnalysis || {};
        result.aiResponseAnalysis.penalties = {
...
//# sourceMappingURL=improvedErrorExtractor.js.map