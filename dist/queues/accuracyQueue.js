...
// ============================================
const accuracyWorker = new Worker('accuracy-analysis', async (job) => {
    ...
    try {
        ...
        const analysis = await calculator.analyzeMessage(userMessage, aiResponse, {
            tier: userTier,
        ...
        const publishedSnapshot = analysis.currentAccuracy ?? analysis.publishedAccuracy ?? analysis;
        await progressOptimizationService.updateAccuracyData(userId, {
        ...
        const finalAccuracy = (publishedSnapshot.overall ?? analysis.overall) || 0;
 ...
 */
export async function queueAccuracyAnalysis(data) {
...
//# sourceMappingURL=accuracyQueue.js.map